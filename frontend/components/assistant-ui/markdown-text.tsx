...
import { ChartRenderer } from "@/components/assistant-ui/chart-renderer";
...
const defaultComponents = memoizeMarkdownComponents({
  h1: ({ className, ...props }) => (
    <h1
      className={cn(
        "aui-md-h1 mb-2 scroll-m-20 text-2xl font-semibold first:mt-0 last:mb-0",
        className,
      )}
      {...props}
    />
  ...
  h2: ({ className, ...props }) => (
    <h2
      className={cn(
        "aui-md-h2 mt-3 mb-1.5 scroll-m-20 text-xl font-semibold first:mt-0 last:mb-0",
        className,
      )}
      {...props}
    />
  ...
  h3: ({ className, ...props }) => (
    <h3
      className={cn(
        "aui-md-h3 mt-2.5 mb-1 scroll-m-20 text-lg font-semibold first:mt-0 last:mb-0",
        className,
      )}
      {...props}
    />
  ...
  p: ({ className, ...props }) => (
    <p
      className={cn(
        "aui-md-p my-2.5 text-lg leading-relaxed first:mt-0 last:mb-0",
        className,
      )}
      {...props}
    />
  ...
  li: ({ className, ...props }) => (
    <li className={cn("aui-md-li text-lg leading-relaxed", className)} {...props} />
  ),
  sup: ({ className, ...props }) => (
    <sup
  ...
  code: function Code({ className, children, ...props }) {
    ...
    if (isCodeBlock && isChart) {
      return <ChartRenderer code={String(children).trim()} />;
    }
