      ...
      <ComposerPrimitive.AttachmentDropzone asChild>
        ...
        >
          ...
          <ComposerPrimitive.Input
            ...
            className="aui-composer-input placeholder:text-muted-foreground/80 max-h-32 min-h-10 w-full resize-none bg-transparent px-1.75 py-1 text-lg outline-none"
            rows={1}
            autoFocus
  ...
  return (
    ...
    >
      <div
        ...
        className="text-foreground px-2 text-lg leading-relaxed wrap-break-word [contain-intrinsic-size:auto_24px] [content-visibility:auto]"
      >
  ...
  return (
    ...
    >
      ...
      <div className="aui-user-message-content-wrapper relative col-start-2 min-w-0">
        <div className="aui-user-message-content peer bg-muted text-foreground rounded-2xl px-4 py-2.5 text-lg wrap-break-word empty:hidden">
          <MessagePrimitive.Parts />
        </div>
